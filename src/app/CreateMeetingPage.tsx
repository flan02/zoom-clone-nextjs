...
export default function CreateMeetingPage() {
  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      ...
      <div className="mx-auto w-96 space-y-6 bg-[#191F1F] border border-slate-950 rounded-lg py-10 px-20">
      ...
      {active && (
        <label className="block space-y-1">
          ...
          <textarea
            ...
            maxLength={500}
            className="w-full rounded-md border border-crybaby bg-night p-2"
          />
        </label>
      )}
    </div>
